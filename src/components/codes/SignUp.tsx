...
const SignUp = () => {
    ...
    const [errors, setErrors] = useState<Errors>({confirmPassword: false, password: false, email: false});
    ...
    useEffect(() => {
        const newErrors: Errors = {confirmPassword: false, password: false, email: false}
            ...
            <div className="container">
                <div className={styles.formContainer}>
                    ...
                    <div className={styles.inputBox}>
                        ...
                        {showModal && <MessageModal title={title} text={text} onClose={() => { setShowModal(false); login() }} />}
                    </div>
