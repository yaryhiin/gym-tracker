...
const Home = ({userName}: homeProps) => {
  ...
  return (
    <div className={styles.container}>
        ...
        <button className={styles.button} onClick={startWorkout}>Push Day</button>
        <button className={styles.button} onClick={startWorkout}>Pull Day</button>
        <button className={styles.button} onClick={startWorkout}>Leg Day</button>
        <button className={styles.button} onClick={startWorkout}>Custom Workout</button>
        </div>
